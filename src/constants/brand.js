/** Elevate Bright Tec (EBT) — desktop app branding (aligned with EBT-Frontend). */

export const BRAND_COMPANY_NAME = 'Elevate Bright Tech'
...
export const BRAND_ORANGE = '#EE651A'
